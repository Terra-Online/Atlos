...
def main():
    if len(sys.argv) != 5:
        print("Usage: python script.py source.json EN.json ZH.json output.json")
        return
    ...
    for top_key in source_json:
        ...
        for obj in source_json[top_key]:
            ...
            for key, value in obj.items():
                ...
                # Try to find match in the EN reference
                key_path = en_value_to_key.get(hashable_value)
                
                # If string value, try Unicode escape methods
                ...
                # Store the translation with the original key
