...
export class MarkerLayer {
    ...
    constructor(map: L.Map, onSwitchCurrentMarker?: (marker: IMarkerData) => void) {
        this.map = map
        ...
        this.layerSubregionDict = Object.values(REGION_DICT).reduce((acc, region) => {
            region.subregions.forEach(subregion => {
                acc[subregion] = new L.LayerGroup([], { pane: "markerPane" });
            });
            return acc;
        }, {})
